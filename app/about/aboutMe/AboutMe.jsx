    ...
    <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-1 gap-4 pt-10 md:mt-20 w-full md:w-[60rem]">
      <div id="summary-text-container">
        ...
        <p className="text-[14px] pl-2 pr-2 font-thin tracking-wide @apply whitespace-pre-line md:pr-10 md:pl-10 pb-10 text-center md:text-start">
          ...
          and knowledge in the world of web development.
        </p>
        <p className="text-[14px] pl-2 pr-2 font-thin tracking-wide @apply whitespace-pre-line md:pr-10 md:pl-10 pb-10 text-center md:text-start">
          ...
          Developer. I am passionate about creating innovative and user-friendly
          digital solutions, and I am excited to see where this journey in
          programming will take me.
        </p>
      </div>
      <div
